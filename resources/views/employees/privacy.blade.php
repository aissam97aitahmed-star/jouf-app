                    ...
                    @foreach ($policies as $policy)
                        <div class="box mb-5">
                            ...
                            @php
                                ...
                                $percent = $totalEmployees > 0 ? round(($viewed / $totalEmployees) * 100) : 0;
                            @endphp

                            <div class="progress__rate">
                                <div class="d-flex justify-content-between">
                                    <p class="tajawal-medium fs-14">معدل الاطلاع</p>
                                    <strong class="percent tajawal-bold fs-14">{{ $percent }}%</strong>
                                </div>
                                ...
                                <p class="tajawal-regular fs-12">{{ $viewed }} موظف اطلع على هذه السياسة</p>
                            </div>
                        </div>
                    @endforeach
