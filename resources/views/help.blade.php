                                ...
                                <div class="col">
                                    ...
                                    <ul class="pc-mega-list">
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Menus</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Media Sliders / Carousel</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Modals</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Pagination</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Progress Bars &amp; Graphs</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Search Bar</a></li>
                                        <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i>
                                                Tabs</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>DataTables has most features enabled by default, so all you need to do to use it with
                                your own tables is to call the
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>With DataTables you can alter the ordering characteristics of the table at
                                initialization time. Using the order
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>DataTables allows ordering by multiple columns at the same time, which can be
                                activated in a number of different
                                ways</small>
                        </div>
                        <div class="card-body">
                            <div class="dt-responsive table-responsive">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>When using tables to display data, you will often wish to display column information
                                in groups. DataTables fully supports
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>When customizing DataTables for your own usage, you might find that the default
                                position of the feature elements (filter
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>The default page control presented by DataTables (forward and backward buttons with
                                up to 7 page numbers in-between) is
                                fine for most situations, but there are cases where you may wish to customizing the
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>This example shows the DataTables table body scrolling in the vertical direction.
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>This example shows a vertically scrolling DataTable that makes use of the CSS3 vh
                                unit in order to dynamically resize the
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>A dot (.) is used to mark the decimal place in Javascript, however, many parts of the
                                world use a comma (,) and other
                                characters such as the Unicode decimal separator (⎖) or a dash (-) are often used to
                                show the decimal place in a displayed
                                number.</small>
                        </div>
                        <div class="card-body">
                            <div class="dt-responsive table-responsive">
