                        ...
                        <form method="POST" action="{{ route('manager.login.submit') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="type d-grid gap-3"
                                    ...
                                    <a href="" class="btn btn-primary tajawal-medium fs-14 w-100 active">مدير الامن</a>
                                    <a href="" class="btn btn-primary tajawal-medium fs-14 w-100 ">موظف الامن</a>
                                    <a href="" class="btn btn-primary tajawal-medium fs-14 w-100 ">زائر</a>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-container">
                                    ...
                                    <input type="text" placeholder="ادخل الرقم الوظيفي" name="email" value="manager@example.com" required
                                        class="visitor-input tajawal-medium fs-14">
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="" class="tajawal-medium fs-14 mb-2" style="color: #374151;">كلمة المرور
                                </label><br>
                                <div class="input-container">
                                    <input type="text" placeholder="********" name="password" required
                                        class="visitor-input tajawal-medium fs-14" value="Aljouf19876" >
                            ...
                            <div class="mb-3 d-flex align-items-center justify-content-between">
                                ...
                                <a href="" class="tajawal-regular fs-14" style="color: #00471F;">نسيت كلمة المرور؟</a>
                            </div>
                            <div class="mb-4">
