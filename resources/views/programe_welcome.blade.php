...
<body>
    ...
    <section class="visitor__login employees__new__login">
                ...
                <div class="col-md-6 p-0">
                    ...
                    <div class="d-flex justify-content-center pb-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                <label for="" class="tajawal-medium fs-14 mb-2" style="color: #374151;">
                                    اسم المستخدم</label><br>
                                <div class="input-container">
                                    <span class="input-icon"><i class="bi bi-person"></i></span>
                                    <input type="text" placeholder="Amr" name="username" :value="old('username')"
                            ...
                            <div class="line-container mb-3">
                                ...
                                <span class="text tajawal-regular fs-14">أو</span>
                                <span class="line"></span>
                            </div>
                            ...
                            <div class="">
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 mb-2">
                                        <button class="btn btn-outline-dark w-100 gray_border" type="button">
                                            <img src="{{ asset('assets/images/gmail-svgrepo-com.svg') }}" alt=""
                                                width="25px">
                                            Google
                                        </button>
                                    </div>
                                    <div class="col-md-6 col-xs-12 mb-2">
                                        <button class="btn btn-outline-dark w-100 gray_border" type="button">
                                            <img src="{{ asset('assets/images/microsoft-svgrepo-com.svg') }}"
                                                alt="" width="25px">
                                            Microsoft
                                        </button>
                                    </div>
