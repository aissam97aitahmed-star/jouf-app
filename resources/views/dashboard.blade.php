            ...
            <div class="row">
                <div class="col-md-8 col-xs-12 mb-3">
                    <div class="welcome text-white">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="tajawal-bold">مرحباً بك عمرو في شركة الجوف !</h4>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 col-xs-12 text-center stat mb-2">
                                <strong class="tajawal-bold fs-30">6</strong> <br>
                                <strong class="tajawal-bold">المواقع</strong>
                            </div>
                            <div class="col-md-4 col-xs-12 text-center stat mb-2">
                                <strong class="tajawal-bold fs-30">8</strong> <br>
                                <strong class="tajawal-bold">الفيديوهات</strong>
                            </div>
                            <div class="col-md-4 col-xs-12 text-center stat mb-2">
                                <strong class="tajawal-bold fs-30">4</strong> <br>
                ...
                <div class="col-md-4 col-xs-12 mb-3">
                    <div class="quickly__actions">
                        ...
                        <a class="mb-2" href=""><i class="bi bi-play-fill"></i> &nbsp;&nbsp; مشاهدة
                            الفيديوهات</a>
                        <a class="mb-2" href=""><i class="bi bi-play-fill"></i> &nbsp;&nbsp; مشاهدة
                            الفيديوهات</a>
                        <a class="mb-5" href=""><i class="bi bi-play-fill"></i> &nbsp;&nbsp; مشاهدة
                            الفيديوهات</a>
